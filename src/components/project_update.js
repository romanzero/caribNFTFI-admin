...
class ProjectUpdate extends React.Component {
    ...
    getProject(id) {
        ...
        .then((res) => {
            ...
            if (res.result) {
                ...
                $("#link_prefix").val(res.data.link_prefix);
            }
        })
        .catch((err) => {
            console.log(err);
    ...
    handleAddProject() {
        ...
        if (valid.valid_name && valid.valid_link_prefix && valid.valid_thumbnail) {
            this.showLoading();
            API.update_project(this.props.params.id, name, link_prefix, thumbnail[0])
            .then((res) => {
                this.hideLoading();
                        ...
                        <div className="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                            <div className="d-flex">
                                <div className="breadcrumb">
                                    ...
                                    <span className="breadcrumb-item active">Edit project</span>
                                </div>
                            </div>
                        </div>
                    </div>
